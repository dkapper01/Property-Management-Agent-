	...
	return (
		<div className="mx-auto flex max-w-(--reading-column) flex-col gap-8 px-6 py-10 md:px-8">
			<header className="mb-2">
				...
				<h1 className="text-h4 font-serif tracking-tight">Welcome back</h1>
				<p className="text-body-2xs text-muted-foreground mt-1">
					Sign in to manage your property memory and timeline.
				</p>
			</header>
			...
			<section className="max-w-md border-y border-border/40 py-6">
				...
				<div className="mt-6 grid gap-5 border-t border-border/40 pt-5">
					<PasskeyLogin
				...
				<div className="flex items-center gap-2 pt-6 text-body-2xs text-muted-foreground">
					<span>New here?</span>
					<Link
						to={
							redirectTo
